...
3.) Add teh xml_set_element_handler() function to specify which function will be executed when the parser encounters the opening and closing tags.
...
AJAX allows web pages to be updated asynchronously by exchanging samll amounts of data with the server behind the scenes. This means that it is possible to update parts of a web page, without reloading the whole page.
...
// PHP also stores all global variables in an array called $GLOBALS[index]. The index holds the name of the variable. THis array is alos accessible from within functions and can be used to updatge global variables directly.
...
//            case-insesitive: specifies wheter the constant name should be case-insensitive. Default is false
